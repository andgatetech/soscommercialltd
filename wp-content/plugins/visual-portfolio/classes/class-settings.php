                    ...
                    'desc'    => '
                        <div class="vpf-settings-info-pro">
                            ...
                            <div>
                                ...
                                <a class="vpf-settings-info-pro-button" target="_blank" rel="noopener noreferrer" href="https://visualportfolio.co/pro/?utm_source=freeplugin&utm_medium=link&utm_campaign=plugin_settings&utm_content=2.14.1">' . esc_html__( 'Read More', 'visual-portfolio' ) . '</a>
                            </div>
                        </div>
                    ',
                    'type'    => 'html',
